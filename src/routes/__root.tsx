...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elev8 Services California" },
      {
        name: "description",
        content:
          "Elev8 Services California provides person-centered residential, supported living, and day services to adults with developmental disabilities throughout California.",
      },
      { name: "author", content: "Elev8 Services" },
      { property: "og:title", content: "Elev8 Services California" },
      {
        property: "og:description",
        content:
          "Care that helps every person rise. Person-centered residential, supported living, and day services for adults with developmental disabilities.",
      },
